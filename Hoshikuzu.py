...
if not TOKEN:
    print("❌ Aucun token Discord détecté !")
    print("➡️ Vérifie sur Render que tu as bien ajouté une variable :")
    print("   Key: DISCORD_TOKEN")
    print("   Value: ton_token_bot")
else:
    ...
    @bot.event
    async def on_ready():
        print(f"🌸 Hoshikuzu est en ligne et prêt à illuminer ton serveur 💜 ({bot.user})")
